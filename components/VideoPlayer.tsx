                    ...
                    <div className="absolute inset-0 bg-black/80 flex flex-col items-center justify-center z-20 animate-fade-in text-white space-y-6">
                        ...
                        <div className="flex gap-4">
                            <button
                                ...
                                className="px-6 py-2 rounded-full border border-white hover:bg-white/20 transition-colors flex items-center font-semibold"
                            >
                            ...
                            {nextVideoId && (
                                <Link
                                    ...
                                    className="bg-blue-600 hover:bg-blue-700 text-white font-bold px-8 py-2 rounded-full transition-transform transform hover:scale-105 flex items-center"
                                >
                                    Next Lesson &rarr;
                                </Link>
                            )}
